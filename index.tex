...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, coltitle=black, arc=.35mm, titlerule=0mm, left=2mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, toprule=.15mm, leftrule=.75mm]
...
standard deviations. Let's see what seems to distinguish some these
