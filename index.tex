...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, breakable, left=2mm, coltitle=black, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, arc=.35mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, titlerule=0mm, toptitle=1mm, leftrule=.75mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, breakable, left=2mm, coltitle=black, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, arc=.35mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, opacityback=0, titlerule=0mm, toptitle=1mm, leftrule=.75mm, colback=white]
...
Okay. This is not revealing much either. All the lines seem to have a
(slight) negative relationship, where y decreases as x increases. The
correlations aren't revealing any notable distinctions, and we don't
seem to be getting anywhere in telling these data sets apart. Maybe
these data sets aren't so different after all\ldots{}

But let's go ahead and plot the actual data and be sure.
...
quartet'} which likewise illustrates the importance of plotting data.
