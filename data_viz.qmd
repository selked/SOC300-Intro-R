...
### Contingency tables
We can also make a quick and easy contingency table for bivariate analysis. Let's re-create our `cappun`/`dem_rep` table.
...
our_gss |>
  ...
  tbl_strata(
    ...
    .tbl_fun = 
      ...
      modify_header(label ~ "**Variable**") |>
      modify_spanning_header(all_stat_cols() ~ "**Death Penalty Approval**") |>
      add_n() |>
      add_p()
