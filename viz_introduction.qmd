...
I'll use some tidyverse commands to get some summary statistics for each of the data sets, including the mean of both variables and their standard deviations. Let's see what seems to distinguish some these datasets from one another.
...
```
Okay. This is not revealing much either. All the lines seem to have a (slight) negative relationship, where y decreases as x increases. The correlations aren't revealing any notable distinctions, and we don't seem to be getting anywhere in telling these data sets apart. Maybe these data sets aren't so different after all...
