...
All of the CHASS computers (and likely most NC State computers) come with R, so you do not need to download it, but you may find it convenient to work on R assignments using your own personal device, so please refer to the directions below in that case. 
