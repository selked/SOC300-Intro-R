...
For example, in the following table, the first column (labeled 'Democrat') tells us that 42.8% of all Democrats in the sample favor the death penalty and 57.2% of all Democrats oppose the death penalty. This adds to 100% of all Democrats we sampled. 

To interpret the relationship between variables, we can read across the rows. Only 42.8% of Democrats favor the death penalty whereas 84% of Republicans favor the death penalty. Comparing these proportions gives us a clear picture of the nature of the association, or, in other words, the political party that is more associated with favoring or opposing the death penalty.
...
# Make a quick and easy contingency table with base R & then turn that into a data frame
