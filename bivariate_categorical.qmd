...
And emember that our hypotheses are generally going to be tested against a null hypothesis, which assumes that whatever relationship you predict is not the case.
...
dev_fav_chisq <- chi_numerator/chi_denominator
```
...
In the case that your p-value is this small, it's common convention to simply report that your it is \< 0.001.
