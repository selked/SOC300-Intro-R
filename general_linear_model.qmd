...
So, we include the error term as a placeholder for all the variation in our dependent variable that is still unexplained after accounting for all of our independent and control variables. If the slope coefficient of our independent variable is the effect of $X$ on $Y$, then you can think of the error term as capturing the effect on $Y$ of everything else our model is incapable of accounting for. 
