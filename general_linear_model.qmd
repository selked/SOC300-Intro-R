...
- modeling continuous dependent variables (ordinal least squares regression)
...
This is trivial for our case, given that our example line has very few data points and an incredibly simple relation (where $X = Y$). 
