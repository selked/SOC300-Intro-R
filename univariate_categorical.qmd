...
Well, hold on. In the case of `age_ord`, it looks like we'd actually want to take the mode, because it's a bit left-skewed. We can see that when we make the barplot
